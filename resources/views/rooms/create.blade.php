                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ action('RoomController@store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control{{ $errors->has('Room') ? ' is-invalid' : '' }}" name="Room" value="{{ old('Room') }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control{{ $errors->has('Floor') ? ' is-invalid' : '' }}" name="Floor" value="{{ old('Floor') }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control{{ $errors->has('RoomType') ? ' is-invalid' : '' }}" name="RoomType" value="{{ old('RoomType') }}" required autofocus>
